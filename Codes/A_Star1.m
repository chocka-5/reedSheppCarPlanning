function [timeElapsed,cost1,C,D,Optimal_path] =A_Star1(obs,xs,ys,xt,yt,xm,v,vw)
...
%goal_distance= distance((xNode-0.5)*r,(yNode-0.5)*r,(xTarget-0.5)*r,(yTarget-0.5)*r,theta1,0);
...
% plot(xNode+.5,yNode+.5,'go');
 ...
 exp_array=expand_array_dublin(xNode,yNode,path_cost,xTarget,yTarget,A,theta1,obs,r,v,CLOSED,MAX_X,MAX_Y);
...
if ((xval == xTarget) && (yval == yTarget))
 ...
 for n= 1:(length(B)-1)
     ...
     [X,Y,t1,~] =cost((x1-0.5)*r,(y1-0.5)*r,b,(x2-0.5)*r,(y2-0.5)*r,v,0.1,vw*v,1.57,r,u,j,k,obs);
     C = [C X];
     D = [D Y];
